...
namespace Lime.Protocol.UnitTests.Network.Modules
{
    ...
    public class ResendMessagesChannelModule2Tests : IDisposable
    {
        ...
        private readonly List<ResendMessagesChannelModule2> _targets;

        public ResendMessagesChannelModule2Tests()
        {
        ...
        private ResendMessagesChannelModule2 GetTarget(bool setEstablishedState = true, Mock<IChannel> channel = null, IMessageStorage messageStorage = null)
        {
            if (channel == null) channel = _channel;

            var target =
                ResendMessagesChannelModule2.CreateAndRegister(channel.Object, _resendMessageTryCount,
