...
{
    public class WebSocketTransportListener2 : ITransportListener
    {
        ...
        public WebSocketTransportListener2(
            Uri listenerUri, 
                ...
                try
                {
                    ...
                    if (httpContext.Request.IsWebSocketRequest)
                    {
                        var context = await httpContext.AcceptWebSocketAsync(
                            ...
                            .WithCancellation(cancellationToken)
                            .ConfigureAwait(false);
                        return new ServerWebSocketTransport2(context, _envelopeSerializer, _traceWriter, _bufferSize);
                    }
