...
{
    public class PipeWebSocketTransportListener : ITransportListener
    {
        ...
        private async Task ProcessHttpContextAsync(HttpContext context)
        {
            ...
            var transport = new PipeServerWebSocketTransport(
                context, webSocket, _envelopeSerializer, _traceWriter, _webSocketMessageType, _closeGracefully, _pauseWriterThreshold, _memoryPool);
