...
namespace Lime.Protocol
{
    ...
    public class Session : Envelope
    {
        ...
        /// <returns></returns>
        internal static Session FromJsonObject(JsonObject jsonObject)
        {
            if (jsonObject == null)
            {
            ...
            Envelope.PopulateFromJsonObject(session, jsonObject);
                ...
                jsonObject.ContainsKey(AUTHENTICATION_KEY))
            {
                ...
                var authenticationDictionary = (JsonObject)jsonObject[AUTHENTICATION_KEY];
                session.Authentication = Authentication.FromJsonObject(authenticationDictionary, scheme);
            }
