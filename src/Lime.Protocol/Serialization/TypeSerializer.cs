...
namespace Lime.Protocol.Serialization
{
                ...
                if (setMethod != null)
                {
                    ...
                    if (propertyType.IsArray)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                throw new NotSupportedException(string.Format("The type '{0}' of the property '{1}' is not supported", property.PropertyType, memberName));
                            }
                        }
                    }
                    ...
                    else if (TypeUtil.IsProtocolType(propertyType))
                    {
                        ...
                        // for the property, so it must be deserialized
                    ...
                    _deserializePropertyActions[i] = deserializePropertyAction;
                }
    ...
    public static class TypeSerializer
    {
        ...
        private static ConcurrentDictionary<Type, Func<string, object>> _deserializeFuncDictionary = new ConcurrentDictionary<Type, Func<string, object>>();

        private static ConcurrentDictionary<Type, Func<JsonObject, object>> _parseJsonFuncDictionary = new ConcurrentDictionary<Type, Func<JsonObject, object>>();
